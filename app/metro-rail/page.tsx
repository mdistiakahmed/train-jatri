...
const ScheduleTable = ({ title, schedule }: { title: string; schedule: { from: string; to: string; first: string; last: string }[] }) => (
  <div className="my-10">
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          ...
          <div className="max-w-3xl mx-auto text-gray-700 text-lg">
            <p className="mb-4">
              The <strong>Dhaka Metro Rail schedule</strong> operates regularly from <strong>Sunday to Thursday</strong>.
              Trains start from <strong>Uttara North at 7:10 AM</strong> and the last train departs at <strong>9:00 PM</strong>.
              From <strong>Motijheel</strong>, the first train leaves at <strong>7:30 AM</strong> and the final service runs until <strong>9:40 PM</strong>.
            </p>
            <p className="mb-4">
              On <strong>Fridays</strong>, metro services are available in the afternoon, starting from <strong>3:00 PM</strong> to <strong>9:40 PM</strong>.
              On <strong>Saturdays and public holidays</strong>, the metro follows the regular weekday schedule.
            </p>
            <p>
              Check the latest <strong>Dhaka Metro Rail time schedule</strong> before travel for any updates or special day adjustments.
            </p>
          </div>
        </div>
