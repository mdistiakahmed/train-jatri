...
export const TableOfContents = ({ groupedRoutes, stationName }: { groupedRoutes: { [key: string]: any[] }; stationName: string }) => {
...
export const generateForwardTrainsDescription = (stationName: string, forwardTrains: any[]) => {
...
export const generateReverseTrainsDescription = (stationName: string, reverseTrains: any[]) => {
...
export const groupTrainsByDestination = (trainData: any, currentStation: string) => {
...
export const GroupedTrainSchedules = ({groupedRoutes}: {groupedRoutes: { [key: string]: any[] }}) => {
